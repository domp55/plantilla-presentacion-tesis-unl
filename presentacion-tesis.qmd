...
## {.portada data-state="portada" data-menu-title="Portada" data-background-color="#E30613" data-background-gradient="linear-gradient(135deg, #E30613 0%, #B8050F 60%, #8B0000 100%)"}

<div style="text-align:center;">
<img src="assets/logoUNL.png" class="logo-portada" alt="Logo UNL">

<p class="subtitulo">Facultad de la Energía, Las Industrias y los Recursos Naturales No Renovables<br>Carrera de Computación</p>

<h2>«Título de tu Trabajo de Tesis aquí»</h2>

<div class="linea-decorativa"></div>

<div class="info-tesis">
<strong>Autor:</strong> «Nombre del Estudiante»<br>
<strong>Director:</strong> «Nombre del Director de Tesis»<br><br>
<strong>Loja – Ecuador</strong> | «Año»
</div>
</div>
