  ...
  revealjs:
    ...
    include-in-header:
      text: |
        ...
        /* Columna compacta: texto más pequeño para que quepa el QR + enlace */
        .reveal .compacto li { font-size: 0.72em; line-height: 1.3; margin-bottom: 0.35em; }
        ...
        .concept-col .concept-card { font-size: 0.55em; padding: 11px 16px; }
...
## Resultado — Clúster funcionando {data-menu-title="Objetivo 1 · Funcionando"}

::: {.columnas}
::: {.col-txt}

- Los **4 nodos activos** y el servidor web repartido en los trabajadores
- **Ningún fallo** en las 21 ejecuciones

:::
::: {.col-fig .stack}

![Los cuatro nodos activos](assets/getNode-O-Wide.png)

![Una copia del servidor web en cada trabajador](assets/getPods-O-Wide.png)
...
- Se concluye que **quedó medido el nivel de latencia y throughput** del clúster: las 21 ejecuciones fueron **consistentes** y suficientes para responder la pregunta de investigación.
- El estudio no solo midió el rendimiento, sino que además **determinó el factor que lo condiciona**.

**Objetivo específico 1 — cumplido**

- Se concluye que **el prototipo físico es estable y funcional**: operó **sin un solo fallo** en las 21 ejecuciones, quedando listo para la orquestación.
- El resultado es además **ampliable y reproducible** (diseño en 3D público).

**Objetivo específico 2 — cumplido**

- Se concluye que **el despliegue web con Kubernetes fue exitoso** y que las métricas de latencia y throughput quedaron **registradas bajo carga**.
- El análisis permitió, además, **explicar por qué el sistema rinde así** y qué lo limita.
